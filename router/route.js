...
const { register_user, register_submit, register_resend_otp, login_user, send_otp_user, submit_otp_user, appointment_user, update_data_user, send_email_message, send_sms_message, get_user, get_all_user , appointments_Unavailable } = require("../controller/userController")
const { appointment, appointment_unavailable, appointment_All , appointment_delete } = require("../controller/appointmentController")
const { post_contact, get_contact } = require("../controller/contactController")
